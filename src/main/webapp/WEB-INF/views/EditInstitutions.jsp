								...
								<span class="custom-checkbox">
									...
									<label for="checkbox1"></label>
                                        ...
                                        <td>
                                            ...
                                            <a href="<c:url value ="/editInstitution/${institution.id}"/>" class="edit"
                                               data-toggle="modal"><i
...
<script>
    document.querySelector('#deleteEmployeeModal'), function (e) {
        let modalId = document.querySelector(e.relatedTarget).data('institution-id');
        console.log(modalId);
        /*    $(e.currentTarget).find('input[name="deleteInstitution"]');*/
